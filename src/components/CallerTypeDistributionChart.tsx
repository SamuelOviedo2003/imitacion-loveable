...
// App theme colors - vibrant and consistent (different order for variety)
const COLORS = [
  '#10b981', // Emerald
  '#3b82f6', // Blue
  '#f59e0b', // Amber
    ...
    return (
      <Card className="h-full shadow-sm hover:shadow-md transition-shadow duration-200">
        <CardHeader className="pb-4">
          <CardTitle className="text-lg font-semibold text-gray-900">Caller Type Distribution</CardTitle>
        </CardHeader>
        <CardContent>
    ...
    <Card className="h-full shadow-sm hover:shadow-md transition-shadow duration-200">
      <CardHeader className="pb-4">
        ...
        <p className="text-sm text-gray-600 mt-1">
          Caller type breakdown • {totalCalls} total calls
        </p>
      </CardHeader>
      <CardContent>
